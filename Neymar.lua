...
local Window = Libary:MakeWindow({
    Title = "CNeymar Hub | Brookhaven RP ",
    SubTitle = "by: Luscaa and venom",
    LoadText = "Carregando Neymar Hub",
    Flags = "NeymarHub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://81886512783938", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})

local InfoTab = Window:MakeTab({ Title = "Info", Icon = "rbxassetid://81886512783938" })
...
local TrollTab = Window:MakeTab({ Title = "Scripts Trolls", Icon = "rbxassetid://81886512783938" })
